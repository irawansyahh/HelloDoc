...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url('assets/CariRS.css')?>">
    ...
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
         <form class="form-inline my-2 my-lg-0">
            <i><img src="<?= base_url('assets/search2.png')?>" width="15px;" style="position:absolute; left: 120px; margin-top:-7px;"></i>
