<?php $this->load->view('Page_header')?>
    ...
    <div class="side-container" style="margin-top: 115px;">
       ...
       <div class="main-container2" style="position:relative;margin-left:270px;margin-top:-570px;margin-bottom:84px;"> 
            <div class="search-tab-menu-container"> 
                <div class="search-tab-menu"> 
                    <ul class="nav">
                    <li class="nav-item" style="width: 180px; text-align: center; margin-left: 340px;">
            ...
            <form class="form-profil" style="position:relative;margin-left:230px;margin-top:90px;">
                ...
                <button class="btn btn-primary btn-download" style="margin-left:389px;">Perbarui Profil</button>
